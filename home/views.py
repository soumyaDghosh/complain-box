...
# class UserComment(LoginRequiredMixin, FormView):
#     template_name = 'complaint/comments.html'
#     form_class = CommentForm
#     model = Comment

#     def get_object(self):
#         return Complaint.objects.get(id=self.kwargs['comp_pk'])

#     def get_context_data(self, **kwargs):
#         context = super().get_context_data(**kwargs)
#         context['comments'] = Comment.objects.filter(complaint=self.get_object())
#         return context

#     def form_valid(self, form):
#         comment = form.save(commit=False)
#         comment.complaint = self.get_object()
...
#         messages.warning(self.request, 'Please write something!')
#         return self.render_to_response(self.get_context_data(form=form))

#     def get_success_url(self):
#         return reverse('user_comment', kwargs={'comp_pk': self.kwargs['comp_pk']})
